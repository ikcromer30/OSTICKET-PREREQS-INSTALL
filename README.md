...
2.) After you create the virtual machine the next step is to retreive the public ip from the azure portal and log into it via remote desktop connection app
</p>
<br />
